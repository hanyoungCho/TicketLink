unit Common.HTMLColorConversions;
...
begin
  try
    ...
    Result :=
      Integer(StrToInt('$' + Copy(HTML, LOffset + 1, 2))) +
      Integer(StrToInt('$' + Copy(HTML, LOffset + 3, 2))) shl 8 +
      Integer(StrToInt('$' + Copy(HTML, LOffset + 5, 2))) shl 16;
  except
    // try for color names
